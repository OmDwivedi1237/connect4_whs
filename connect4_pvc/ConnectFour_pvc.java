...
public class ConnectFour_pvc {
    private static final int ROWS = 6;
    private static final int COLS = 7;
    private char[][] board;
    private ConnectFourPlayer_pvc redPlayer;
    private ConnectFourPlayer_pvc blackPlayer;
    private Random random;

    public ConnectFour_pvc(ConnectFourPlayer_pvc redPlayer, ConnectFourPlayer_pvc blackPlayer) {
    ...
    public void makeMove(ConnectFourPlayer_pvc player, char symbol) {
    ...
    public char simulateMatch() {
        ConnectFourPlayer_pvc currentPlayer = random.nextBoolean() ? redPlayer : blackPlayer;
